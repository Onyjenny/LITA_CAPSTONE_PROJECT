...
I was able to deduce that the top selling product is 'shoe' with a value of 613,380 and the least selling product is 'socks' with a value of 180,785.Also the 'South' region has the highest revenue  which is 927,820 while the 'west' region has the least revenue has 300,345.In the year 2023,Sales was made in the month of February to and the total revenuue is 1,105,330 while in 2024 sales was made in the month of February to July, total revenue is 995,760 and both year totals a revenue of 210100
